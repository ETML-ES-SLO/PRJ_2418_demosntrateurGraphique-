...
typedef struct FT_Gpu_Fonts
{
	...
	uint8	FontWidth[FT_GPU_NUMCHAR_PERFONT];
	/* Bitmap format of font wrt bitmap formats supported by FT800 - L1, L4, L8 */
	uint32	FontBitmapFormat;
	/* Font line stride in FT800 ROM */
	uint32	FontLineStride;
	/* Font width in pixels */
	uint32	FontWidthInPixels;
	/* Font height in pixels */
	uint32	FontHeightInPixels;
	/* Pointer to font graphics raw data */
	uint32	PointerToFontGraphicsData;
}FT_Gpu_Fonts_t;
