...
#define BITMAP_LAYOUT_H(linestride, height) ((40UL<<24) | (((linestride)&0x03)<<2) | ((height)&0x03))

    // Non documenté
#define BITMAP_SIZE(filter,wrapx,wrapy,width,height) ((8UL<<24)|(((filter)&1UL)<<20)|(((wrapx)&1UL)<<19)|(((wrapy)&1UL)<<18)|(((width)&511UL)<<9)|(((height)&511UL)<<0))
#define BITMAP_SIZE_H(width, height) ((41UL<<24) | (((width)&0x03)<<2) | ((height)&0x03))
...
#define tr8(value)  _dummy = spi_read1(value);
    //#define tr16(value) tr8((value) & 0xFF);tr8(((value) >> 8) & 0xFF) //LSB first
#define tr16(value) tr8(((value) >> 8) & 0xFF); tr8((value) & 0xFF)
    //#define tr32(value) tr16((value) & 0xFFFF);tr16(((value) >> 16) & 0xFFFF) //LSB first
#define tr32(value) tr8(((value) >> 24) & 0xFF); tr8(((value) >> 16) & 0xFF); tr8(((value) >> 8) & 0xFF); tr8((value) & 0xFF)
...
#define cmd_increment2() cmd_incrementn(2)
     ...
     */
#define cmd_dlstart() dl(CMD_DLSTART)
...
#define cmd_regread(ptr, result)    cmd(CMD_REGREAD);cmd(ptr);cmd(result)
     ...
     */
#define cmd_calibrate() cmd(CMD_CALIBRATE);cmd(0) //;unsigned short cmd_calibrate_result_ptr=cmd_offset;cmd(0)
...
#define cmd_snapshot(ptr) cmd(CMD_SNAPSHOT);cmd(ptr)
     ...
     */
#define cmd_logo() wr32(RAM_CMD + 0, CMD_LOGO) //cmd(CMD_LOGO)
